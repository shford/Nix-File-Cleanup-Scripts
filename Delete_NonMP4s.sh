...
#author  :  Hampton Ford
#purpose :  Removes everything but MP4s and PNGs. Made to streamline Chris' autogenerated Go-Pro footage.
...
if [ $# -ne 1 ]; then
	printf "ERROR:\n"
	printf "Chris, you forgot to drag and drop the folder.\n"
	exit 0
fi
